...
export function PaywallModal() {
  ...
  return (
    <Modal open={showPaywall} onClose={closePaywall} title="Unlock Research" wide>
      <p className="mb-6 text-sm leading-relaxed text-zinc-500">
        {paywallReason ||
          'Starter includes 500 pages and 1 assistant. Upgrade for Protocol AI and unlimited docs.'}
      </p>
          ...
          return (
            ...
            >
              <div className="mb-3 flex items-center justify-between">
                <h4 className="font-display text-lg font-semibold text-black">{p.name}</h4>
                {id === 'research' ? (
              ...
              <p className="mb-4 font-display text-3xl font-semibold tracking-tight text-black">
