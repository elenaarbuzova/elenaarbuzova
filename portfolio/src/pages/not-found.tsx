  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-background text-foreground">
      <div className="w-full max-w-md mx-4 border border-border/40 p-8">
        ...
        <a href="/" className="mt-6 inline-block text-sm font-semibold tracking-widest uppercase border-b border-foreground pb-1 hover:opacity-50 transition-opacity">
          Home
        </a>
      </div>
    </div>
