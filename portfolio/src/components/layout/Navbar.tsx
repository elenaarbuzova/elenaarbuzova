  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 h-20 flex items-center justify-between gap-6">
        <a href="#" className="text-sm font-semibold tracking-wide uppercase shrink-0">
          Elena Arbuzova
        </a>
        ...
        <div className="flex items-center gap-6 md:gap-8">
          <nav className="hidden md:flex gap-8 text-xs font-medium tracking-widest uppercase">
            ...
            <a href="#work" className="hover:opacity-50 transition-opacity">{t.nav.work}</a>
            <a href="#process" className="hover:opacity-50 transition-opacity">{t.nav.process}</a>
            <a href="#testimonials" className="hover:opacity-50 transition-opacity">{t.nav.testimonials}</a>
